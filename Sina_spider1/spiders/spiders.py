...
class Spider(CrawlSpider):
    ...
    host = "http://weibo.cn"
    start_urls = [
        1157049755, 2348287675, 1771140437, 3217179555, 277773956, 2258838562, 1563926367, 1448224822,
        2714280233, 2176141495, 1672202934, 5679064317, 5341832954
    ]
    ...
    def parse1(self, response):
        ...
        vip = re.findall(u'\u8ba4\u8bc1[:|\uff1a](.*?);', text1)  #vip

        if not vip:
            return
        informationItems["VIP"] = vip[0]
        if nickname:
        ...
        for tweet in tweets:
            ...
            if others:
                ...
                if hasMonth:
                    ...
                    if int(month) == int(self.current_month) and (int(self.current_day) - int(day)) <= 1:
